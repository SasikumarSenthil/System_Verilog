...
if(!hresetn) begin  state <= idle; for(int i=0; i<256; i=i+1) mem[i]=8'h00; end
    ...
    case(state)
      ...
      check_mode: begin
        ...
        write: begin
               ...
               3'b011: begin                // 4 beat Incrementing
                       hready = 1'b1;
              ...
              3'b100:begin                // 8 beat wrapping
               ...
               3'b101: begin                // 8 beat Incrementing
                       hready = 1'b1;
                       retaddr = incr_wr(next_addr,hsize);
                       hresp = `OKAY;
               ...
               3'b111: begin                // 16 beat Incrementing
                       hready = 1'b1;
                       retaddr = incr_wr(next_addr,hsize);
                       hresp = `OKAY;
       ...
       read: begin
            ...
            3'b011: begin  // 4 beat increment read
                     hready =1'b1;
            ...
            3'b101: begin  // 8 beat increment read
                     hready =1'b1;
                     retaddr = incr_rd(next_addr,hsize);
                     hresp = `OKAY;
            ...
            3'b111: begin  // 16 beat increment read
                     hready =1'b1;
                     retaddr = incr_rd(next_addr,hsize);
                     hresp = `OKAY;
